...
export default function SkyJumperChat() {
  ...
  // Helper to strip markdown for speech
  ...
  // Clean up speech on unmount or when voice is disabled
  useEffect(() => {
    if (!isVoiceEnabled) {
      window.speechSynthesis.cancel();
    }
        ...
        <div className="mx-auto max-w-5xl px-3 py-3 sm:px-6 sm:py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-1 sm:gap-2">
              <button
                onClick={toggleVoice}
                className={`flex items-center justify-center h-8 w-8 sm:h-10 sm:w-10 rounded-full transition-colors ${
                  isVoiceEnabled
            ...
            <div className="flex min-h-[65vh] flex-col items-center justify-center text-center">
              ...
              <div className="mt-8 sm:mt-12 grid grid-cols-3 gap-4 sm:gap-6 rounded-2xl bg-white border-2 border-orange-100 p-4 sm:p-6 shadow-xl max-w-md w-full mx-4">
                <div className="text-center">
                  <div className="mb-1 text-2xl sm:text-3xl font-bold bg-gradient-to-br from-orange-600 to-orange-500 bg-clip-text text-transparent">
                    23+
                  </div>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="mt-2 sm:mt-3 flex items-center justify-between px-1 text-[10px] sm:text-xs">
              <span className="text-gray-500">
                Press{" "}
                <kbd className="rounded bg-gray-100 px-1.5 py-0.5 font-mono font-semibold border border-gray-200">
                  Enter
                </kbd>{" "}
                to send
              </span>
